...
int main(int argc,char **argv)
{
    ...
    fast_io::dir_file sysrootdirf(os_c_str(argv[1]));
    ...
    for(auto ent : current(at(dirf)))
    {
        ...
        if(vw==u8".h")
        {
            vec.emplace_back(u8filename(ent));
        }
    }
    ::std::ranges::sort(vec);
    ::fast_io::u8obuf_file obf(at(dirf), u8"winrt.ixx");
...
#define WINRT_EXPORT export
    ...
    {
        print(obf,u8"#include \"winrt/",e,u8"\"\n");
    }
}