...
typedef struct ENCLAVE_IDENTITY {
    ...
    UINT32 PlatformSvn;
    UINT32 Flags;
    UINT32 SigningLevel; // Reserved field. Must be zero.
    UINT32 EnclaveType;
} ENCLAVE_IDENTITY;
...
#define VBS_ENCLAVE_VARDATA_PACKAGE     0x00000002
...
typedef struct VBS_ENCLAVE_REPORT_PACKAGE_ID {
    VBS_ENCLAVE_REPORT_VARDATA_HEADER Header;
    ENCLAVE_PACKAGE_IDENTITY PackageIdentity;
} VBS_ENCLAVE_REPORT_PACKAGE_ID;
