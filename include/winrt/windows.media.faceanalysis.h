...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IDetectedFace<D>::FaceBox() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Media::FaceAnalysis::IDetectedFace, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetector<D>::DetectFacesAsync(winrt::Windows::Graphics::Imaging::SoftwareBitmap const& image) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Media::FaceAnalysis::IFaceDetector, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetectorStatics<D>::CreateAsync() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Media::FaceAnalysis::IFaceDetectorStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceTracker<D>::ProcessNextFrameAsync(winrt::Windows::Media::VideoFrame const& videoFrame) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Media::FaceAnalysis::IFaceTracker, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceTrackerStatics<D>::CreateAsync() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Media::FaceAnalysis::IFaceTrackerStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
