...
namespace winrt::impl
{
    ...
    {
        bool value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationData>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::Storage::IApplicationData, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IsMachinePathSupported(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)this;
            check_hresult(_winrt_abi_type->get_IsMachinePathSupported(&value));
        }
        return value;
    }
    ...
    template <typename D> auto consume_Microsoft_Windows_Storage_IApplicationData<D>::ClearAsync(winrt::Microsoft::Windows::Storage::ApplicationDataLocality const& locality) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationData>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->ClearAsync(static_cast<int32_t>(locality), &operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Storage_IApplicationData<D>::ClearPublisherCacheFolderAsync(param::hstring const& folderName) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationData>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->ClearPublisherCacheFolderAsync(*(void**)(&folderName), &operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Storage_IApplicationData<D>::GetPublisherCachePath(param::hstring const& folderName) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationData>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetPublisherCachePath(*(void**)(&folderName), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_Storage_IApplicationData<D>::GetPublisherCacheFolder(param::hstring const& folderName) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationData>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetPublisherCacheFolder(*(void**)(&folderName), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationData>**)this;
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationDataContainer>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::Storage::IApplicationDataContainer, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataContainer>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_Containers(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataContainer>**)this;
            check_hresult(_winrt_abi_type->get_Containers(&value));
        }
    ...
    template <typename D> auto consume_Microsoft_Windows_Storage_IApplicationDataContainer<D>::CreateContainer(param::hstring const& name, winrt::Microsoft::Windows::Storage::ApplicationDataCreateDisposition const& disposition) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationDataContainer>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataContainer>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->CreateContainer(*(void**)(&name), static_cast<int32_t>(disposition), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataContainer>**)this;
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationDataStatics>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::Storage::IApplicationDataStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetDefault(&result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataStatics>**)this;
            check_hresult(_winrt_abi_type->GetDefault(&result));
        }
    ...
    template <typename D> auto consume_Microsoft_Windows_Storage_IApplicationDataStatics<D>::GetForPackageFamily(param::hstring const& packageFamilyName) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Storage::IApplicationDataStatics>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetForPackageFamily(*(void**)(&packageFamilyName), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataStatics>**)this;
