...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_Adc_Provider_IAdcControllerProvider<D>::ChannelCount() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Adc::Provider::IAdcControllerProvider, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Devices_Adc_Provider_IAdcProvider<D>::GetControllers() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Adc::Provider::IAdcProvider, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
