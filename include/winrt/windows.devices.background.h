...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_Background_IDeviceServicingDetails<D>::DeviceId() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Background::IDeviceServicingDetails, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Devices_Background_IDeviceUseDetails<D>::DeviceId() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Background::IDeviceUseDetails, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
