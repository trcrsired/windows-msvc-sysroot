...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Graphics_DirectX_Direct3D11_IDirect3DDevice<D>::Trim() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DDevice, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Graphics_DirectX_Direct3D11_IDirect3DSurface<D>::Description() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
