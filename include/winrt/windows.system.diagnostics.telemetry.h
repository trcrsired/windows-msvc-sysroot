...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryClientStatics<D>::Register(param::hstring const& id) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::System::Diagnostics::Telemetry::IPlatformTelemetryClientStatics, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryRegistrationResult<D>::Status() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::System::Diagnostics::Telemetry::IPlatformTelemetryRegistrationResult, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryRegistrationSettings<D>::StorageSize() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::System::Diagnostics::Telemetry::IPlatformTelemetryRegistrationSettings, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
