...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Data_Pdf_IPdfDocument<D>::GetPage(uint32_t pageIndex) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Data::Pdf::IPdfDocument, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Data_Pdf_IPdfDocumentStatics<D>::LoadFromFileAsync(winrt::Windows::Storage::IStorageFile const& file) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Data::Pdf::IPdfDocumentStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Data_Pdf_IPdfPage<D>::RenderToStreamAsync(winrt::Windows::Storage::Streams::IRandomAccessStream const& outputStream) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Data::Pdf::IPdfPage, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Data_Pdf_IPdfPageDimensions<D>::MediaBox() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Data::Pdf::IPdfPageDimensions, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Data_Pdf_IPdfPageRenderOptions<D>::SourceRect() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Data::Pdf::IPdfPageRenderOptions, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
