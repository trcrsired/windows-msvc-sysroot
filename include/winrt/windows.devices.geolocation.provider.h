...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_Geolocation_Provider_IGeolocationProvider<D>::IsOverridden() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Geolocation::Provider::IGeolocationProvider, D const*>(static_cast<D const*>(this));
