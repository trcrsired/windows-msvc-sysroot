...
namespace winrt::impl
{
    ...
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->Hide(*(void**)(&subtree)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>**)this;
            check_hresult(_winrt_abi_type->Hide(*(void**)(&subtree)));
        }
    }
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_HeatMaps(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings>**)this;
            check_hresult(_winrt_abi_type->get_HeatMaps(&value));
        }
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->TryGetSettings(*(void**)(&compositor), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>**)this;
            check_hresult(_winrt_abi_type->TryGetSettings(*(void**)(&compositor), &result));
        }
