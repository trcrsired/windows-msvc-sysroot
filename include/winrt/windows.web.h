...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Web_IUriToStreamResolver<D>::UriToStreamAsync(winrt::Windows::Foundation::Uri const& uri) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Web::IUriToStreamResolver, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Web_IWebErrorStatics<D>::GetStatus(int32_t hresult) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Web::IWebErrorStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
