...
namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_Windows_PushNotifications_IPushNotificationChannel<D>::Uri() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::PushNotifications::IPushNotificationChannel, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Microsoft_Windows_PushNotifications_IPushNotificationCreateChannelResult<D>::Channel() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::PushNotifications::IPushNotificationCreateChannelResult, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_PushNotifications_IPushNotificationManager<D>::Register() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::PushNotifications::IPushNotificationManager, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_PushNotifications_IPushNotificationManagerStatics<D>::IsSupported() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::PushNotifications::IPushNotificationManagerStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_PushNotifications_IPushNotificationReceivedEventArgs<D>::Payload() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::PushNotifications::IPushNotificationReceivedEventArgs, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
