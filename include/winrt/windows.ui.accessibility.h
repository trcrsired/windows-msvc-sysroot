...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderPositionChangedEventArgs<D>::ScreenPositionInRawPixels() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderService<D>::CurrentScreenReaderPosition() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::UI::Accessibility::IScreenReaderService, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
