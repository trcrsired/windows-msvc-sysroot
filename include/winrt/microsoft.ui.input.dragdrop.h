...
namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDragDropManager<D>::AreConcurrentOperationsEnabled() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDragDropManager, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDragDropManagerStatics<D>::GetForIsland(winrt::Microsoft::UI::Content::ContentIsland const& content) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDragDropManagerStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDragInfo<D>::AllowedOperations() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDragInfo, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDragOperation<D>::AllowedOperations() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDragOperation, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDragUIOverride<D>::Caption() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDragUIOverride, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDropOperationTarget<D>::DropAsync(winrt::Microsoft::UI::Input::DragDrop::DragInfo const& dragInfo) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDropOperationTarget, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_UI_Input_DragDrop_IDropOperationTargetRequestedEventArgs<D>::SetTarget(winrt::Microsoft::UI::Input::DragDrop::IDropOperationTarget const& target) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::UI::Input::DragDrop::IDropOperationTargetRequestedEventArgs, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
