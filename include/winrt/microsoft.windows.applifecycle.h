...
namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_Windows_AppLifecycle_IActivationRegistrationManagerStatics<D>::RegisterForFileTypeActivation(array_view<hstring const> supportedFileTypes, param::hstring const& logo, param::hstring const& displayName, array_view<hstring const> supportedVerbs, param::hstring const& exePath) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::AppLifecycle::IActivationRegistrationManagerStatics, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Microsoft_Windows_AppLifecycle_IAppActivationArguments<D>::Kind() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::AppLifecycle::IAppActivationArguments, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_AppLifecycle_IAppInstance<D>::UnregisterKey() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::AppLifecycle::IAppInstance, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_AppLifecycle_IAppInstanceStatics<D>::GetCurrent() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::AppLifecycle::IAppInstanceStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_AppLifecycle_IAppInstanceStatics2<D>::Restart(param::hstring const& arguments) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::AppLifecycle::IAppInstanceStatics2, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
