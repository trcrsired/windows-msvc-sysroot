...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_Radios_IRadio<D>::SetStateAsync(winrt::Windows::Devices::Radios::RadioState const& value) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Radios::IRadio, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Devices_Radios_IRadioStatics<D>::GetRadiosAsync() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::Radios::IRadioStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
