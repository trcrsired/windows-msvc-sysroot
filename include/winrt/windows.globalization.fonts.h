...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Globalization_Fonts_ILanguageFont<D>::FontFamily() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Globalization::Fonts::ILanguageFont, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Globalization_Fonts_ILanguageFontGroup<D>::UITextFont() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Globalization::Fonts::ILanguageFontGroup, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Globalization_Fonts_ILanguageFontGroupFactory<D>::CreateLanguageFontGroup(param::hstring const& languageTag) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Globalization::Fonts::ILanguageFontGroupFactory, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
