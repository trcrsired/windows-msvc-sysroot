...
namespace winrt::impl
{
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Globalization::IApplicationLanguagesStatics>)
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::Globalization::IApplicationLanguagesStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Globalization::IApplicationLanguagesStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_Languages(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Globalization::IApplicationLanguagesStatics>**)this;
            check_hresult(_winrt_abi_type->get_Languages(&value));
        }
