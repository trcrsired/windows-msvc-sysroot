...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_System_Inventory_IInstalledDesktopApp<D>::Id() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::System::Inventory::IInstalledDesktopApp, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_System_Inventory_IInstalledDesktopAppStatics<D>::GetInventoryAsync() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::System::Inventory::IInstalledDesktopAppStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
