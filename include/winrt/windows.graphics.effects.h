...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Graphics_Effects_IGraphicsEffect<D>::Name() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Graphics::Effects::IGraphicsEffect, D const*>(static_cast<D const*>(this));
