...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_I2c_Provider_II2cControllerProvider<D>::GetDeviceProvider(winrt::Windows::Devices::I2c::Provider::ProviderI2cConnectionSettings const& settings) const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::I2c::Provider::II2cControllerProvider, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_Devices_I2c_Provider_II2cDeviceProvider<D>::DeviceId() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::I2c::Provider::II2cDeviceProvider, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Devices_I2c_Provider_II2cProvider<D>::GetControllersAsync() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::I2c::Provider::II2cProvider, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Windows_Devices_I2c_Provider_IProviderI2cConnectionSettings<D>::SlaveAddress() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::Devices::I2c::Provider::IProviderI2cConnectionSettings, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
