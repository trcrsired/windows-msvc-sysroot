...
namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManager<D>::GetEnvironmentVariables() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::System::IEnvironmentManager, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManager2<D>::AreChangesTracked() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::System::IEnvironmentManager2, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManagerStatics<D>::GetForProcess() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
