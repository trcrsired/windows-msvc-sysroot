...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_Composition_Effects_ISceneLightingEffect<D>::AmbientAmount() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::UI::Composition::Effects::ISceneLightingEffect, D const*>(static_cast<D const*>(this));
    ...
    template <typename D> auto consume_Windows_UI_Composition_Effects_ISceneLightingEffect2<D>::ReflectanceModel() const
    {
        ...
        {
            auto const [_winrt_casted_result, _winrt_cast_result_code] = impl::try_as_with_reason<winrt::Windows::UI::Composition::Effects::ISceneLightingEffect2, D const*>(static_cast<D const*>(this));
            check_hresult(_winrt_cast_result_code);
