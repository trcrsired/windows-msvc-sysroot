...
#define HID_USAGE_HAPTICS_WAVEFORM_COLLIDE                     ((USAGE) 0x1012)
#define HID_USAGE_HAPTICS_WAVEFORM_ALIGN                       ((USAGE) 0x1013)
#define HID_USAGE_HAPTICS_WAVEFORM_STEP                        ((USAGE) 0x1014)
#define HID_USAGE_HAPTICS_WAVEFORM_GROW                        ((USAGE) 0x1015)
