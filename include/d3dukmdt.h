...
//
// Define driver feature versions.
// These pro-processor defines can be used by drivers to conditionally compile code that users the
// structures and enums for the driver features.
// Version 0 just means the driver feature is present in the headers
//

#ifndef DXGK_FEATURE_HWSCH_VERSION
#define DXGK_FEATURE_HWSCH_VERSION 0
#endif

#ifndef DXGK_FEATURE_HWFLIPQUEUE_VERSION
#define DXGK_FEATURE_HWFLIPQUEUE_VERSION 0
#endif

#ifndef DXGK_FEATURE_LDA_GPUPV_VERSION
#define DXGK_FEATURE_LDA_GPUPV_VERSION 0
#endif

#ifndef DXGK_FEATURE_KMD_SIGNAL_CPU_EVENT_VERSION
#define DXGK_FEATURE_KMD_SIGNAL_CPU_EVENT_VERSION 0
#endif

#define DXGK_FEATURE_USER_MODE_SUBMISSION_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_USER_MODE_SUBMISSION_VERSION
#define DXGK_FEATURE_USER_MODE_SUBMISSION_VERSION DXGK_FEATURE_USER_MODE_SUBMISSION_VERSION_INITIAL
#endif

#ifndef DXGK_FEATURE_SHARE_BACKING_STORE_WITH_KMD_VERSION
#define DXGK_FEATURE_SHARE_BACKING_STORE_WITH_KMD_VERSION 0
#endif

#define DXGK_FEATURE_SAMPLE_VERSION_ADD_SUBTRACT 5
#ifndef DXGK_FEATURE_SAMPLE_VERSION
#define DXGK_FEATURE_SAMPLE_VERSION DXGK_FEATURE_SAMPLE_VERSION_ADD_SUBTRACT
#endif

#ifndef DXGK_FEATURE_KERNEL_MODE_TESTING_VERSION
#define DXGK_FEATURE_KERNEL_MODE_TESTING_VERSION 0
#endif

#ifndef DXGK_FEATURE_64K_PT_DEMOTION_FIX_VERSION
#define DXGK_FEATURE_64K_PT_DEMOTION_FIX_VERSION 0
#endif

#ifndef DXGK_FEATURE_GPUPV_PRESENT_HWQUEUE_VERSION
#define DXGK_FEATURE_GPUPV_PRESENT_HWQUEUE_VERSION 0
#endif

#ifndef DXGK_FEATURE_GPUVAIOMMU_VERSION
#define DXGK_FEATURE_GPUVAIOMMU_VERSION 0
#endif

#define DXGK_FEATURE_NATIVE_FENCE_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_NATIVE_FENCE_VERSION
#define DXGK_FEATURE_NATIVE_FENCE_VERSION DXGK_FEATURE_NATIVE_FENCE_VERSION_INITIAL
#endif

#ifndef DXGK_FEATURE_SYNC_PRESENT_RENDER_HWQ_ONLY_VERSION
#define DXGK_FEATURE_SYNC_PRESENT_RENDER_HWQ_ONLY_VERSION 0
#endif

#ifndef DXGK_FEATURE_PROCESS_DEBUG_BLOB_COLLECTION_VERSION
#define DXGK_FEATURE_PROCESS_DEBUG_BLOB_COLLECTION_VERSION 0
#endif

#ifndef DXGK_FEATURE_PANEL_BUFFER_CONTROL_VERSION
#define DXGK_FEATURE_PANEL_BUFFER_CONTROL_VERSION 0
#endif

#define DXGK_FEATURE_TARGET_PROPERTY_MAP_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_TARGET_PROPERTY_MAP_VERSION
#define DXGK_FEATURE_TARGET_PROPERTY_MAP_VERSION DXGK_FEATURE_TARGET_PROPERTY_MAP_VERSION_INITIAL
#endif

#define DXGK_FEATURE_INTELLIGENT_CARVEOUT_VERSION_INITIAL 1
#define DXGK_FEATURE_INTELLIGENT_CARVEOUT_VERSION_2 2
#ifndef DXGK_FEATURE_INTELLIGENT_CARVEOUT_VERSION
#define DXGK_FEATURE_INTELLIGENT_CARVEOUT_VERSION DXGK_FEATURE_INTELLIGENT_CARVEOUT_VERSION_2
#endif

#define DXGK_FEATURE_PARTITION_SEGMENT_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_PARTITION_SEGMENT_VERSION
#define DXGK_FEATURE_PARTITION_SEGMENT_VERSION DXGK_FEATURE_PARTITION_SEGMENT_VERSION_INITIAL
#endif

#define DXGK_FEATURE_INTELLIGENT_CARVEOUT_OS_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_INTELLIGENT_CARVEOUT_OS_VERSION
#define DXGK_FEATURE_INTELLIGENT_CARVEOUT_OS_VERSION DXGK_FEATURE_INTELLIGENT_CARVEOUT_OS_VERSION_INITIAL
#endif

#define DXGK_FEATURE_PAGING_INTENT_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_PAGING_INTENT_VERSION
#define DXGK_FEATURE_PAGING_INTENT_VERSION DXGK_FEATURE_PAGING_INTENT_VERSION_INITIAL
#endif

#define DXGK_FEATURE_SYSMEM_PAGING_VERSION_INITIAL 1
#ifndef DXGK_FEATURE_SYSMEM_PAGING_VERSION
#define DXGK_FEATURE_SYSMEM_PAGING_VERSION DXGK_FEATURE_SYSMEM_PAGING_VERSION_INITIAL
#endif

#ifndef DXGK_QUERYFEATURESUPPORT2_VERSION
#define DXGK_QUERYFEATURESUPPORT2_VERSION 0
#endif
...
#define DXGK_SEGMENTPREFERENCE_PAGEPREFERENCE_LARGE 0x10 // 0b10000

typedef struct _D3DDDI_SEGMENTPREFERENCE2
{
    union
    {
        struct
        {
            UINT SegmentId0      : 4;            // 0x0000000F
            UINT PagePreference0 : 1;            // 0x00000010
            UINT Direction0      : 1;            // 0x00000020
            UINT SegmentId1      : 4;            // 0x000007C0
            UINT PagePreference1 : 1;            // 0x00000020
            UINT Direction1      : 1;            // 0x00000800
            UINT SegmentId2      : 4;            // 0x0001F000
            UINT PagePreference2 : 1;            // 0x00000020
            UINT Direction2      : 1;            // 0x00020000
            UINT SegmentId3      : 4;            // 0x007C0000
            UINT PagePreference3 : 1;            // 0x00000020
            UINT Direction3      : 1;            // 0x00800000
            UINT SegmentId4      : 4;            // 0x1F000000
            UINT PagePreference4 : 1;            // 0x00000020
            UINT Direction4      : 1;            // 0x20000000
            UINT Reserved        : 2;            // 0xC0000000
        };
        UINT Value;
    };
} D3DDDI_SEGMENTPREFERENCE2;

#endif // ((DXGK_FEATURE_PARTITION_SEGMENT_VERSION >= DXGK_FEATURE_PARTITION_SEGMENT_VERSION_INITIAL)
...
typedef enum _DXGK_DRIVER_FEATURE
{
    ...
    //DXGK_DRIVER_FEATURE_ENGINE_PPM_SETTINGS                 = 47,
    DXGK_DRIVER_FEATURE_INTELLIGENT_CARVEOUT                = 48,
    DXGK_DRIVER_FEATURE_TARGET_PROPERTY_MAP                 = 49,
    //DXGK_DRIVER_FEATURE_EXECUTE_TILE_MAPPINGS               = 50,
    DXGK_DRIVER_FEATURE_PARTITION_SEGMENT                   = 51,
    DXGK_DRIVER_FEATURE_PAGING_INTENT                       = 52,
    DXGK_DRIVER_FEATURE_SYSMEM_PAGING                       = 53,
...
#define DXGK_DRIVER_FEATURE_MAX_VALUE 54
#if defined(__cplusplus) && !defined(SORTPP_PASS)
static_assert(DXGK_DRIVER_FEATURE_MAX == DXGK_DRIVER_FEATURE_MAX_VALUE, "DXGK_DRIVER_FEATURE_MAX_VALUE not updated to match DXGK_DRIVER_FEATURE_MAX");
#endif
...
typedef enum _DXGK_OS_FEATURE
{
    ...
    DXGK_OS_FEATURE_IOMMU_ATS_SUPPORT                       = 8,
    //DXGK_OS_FEATURE_EXCLUSIVE_ENGINE_ACCESS                 = 9,
    //DXGK_OS_FEATURE_SIGNAL_FENCE_INTERFACE                  = 10,
    DXGK_OS_FEATURE_INTELLIGENT_CARVEOUT_OS                 = 11,
...
typedef enum _DXGK_FEATURE_ID
{
    ...
    //DXGK_FEATURE_ENGINE_PPM_SETTINGS
    DXGK_FEATURE_INTELLIGENT_CARVEOUT               = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_DRIVER, DXGK_DRIVER_FEATURE_INTELLIGENT_CARVEOUT),
    DXGK_FEATURE_TARGET_PROPERTY_MAP            = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_DRIVER, DXGK_DRIVER_FEATURE_TARGET_PROPERTY_MAP),
    //DXGK_FEATURE_EXECUTE_TILE_MAPPINGS
    DXGK_FEATURE_PARTITION_SEGMENT                  = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_DRIVER, DXGK_DRIVER_FEATURE_PARTITION_SEGMENT),
    DXGK_FEATURE_PAGING_INTENT                      = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_DRIVER, DXGK_DRIVER_FEATURE_PAGING_INTENT),
    DXGK_FEATURE_SYSMEM_PAGING                      = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_DRIVER, DXGK_DRIVER_FEATURE_SYSMEM_PAGING),
    ...
    DXGK_FEATURE_IOMMU_ATS_SUPPORT                  = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_OS, DXGK_OS_FEATURE_IOMMU_ATS_SUPPORT),
    DXGK_FEATURE_INTELLIGENT_CARVEOUT_OS            = DXGK_DEFINE_FEATURE_ID(DXGK_FEATURE_CATEGORY_OS, DXGK_OS_FEATURE_INTELLIGENT_CARVEOUT_OS),
