...
namespace Microsoft.WindowsAppSDK
{
    ...
    namespace Runtime
    {
        ...
        internal class Version
        {
            ...
            internal const ulong UInt64 = 0x1770013E09000000;

            /// The version of the Windows App SDK runtime, as a string (const wchar_t*); for example, "1000.446.804.0".
            internal const string DotQuadString = "6000.318.2304.0";
        }
        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                internal class X86
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.6000.318.2304.0-x8_8wekyb3d8bbwe";
                }
                internal class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.6000.318.2304.0-x6_8wekyb3d8bbwe";
                }
                internal class Arm64
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.6000.318.2304.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
