...
//
// HFP (Hands-Free Profile) Audio Gateway SDP Supported Features
// Used in SDP_ATTRIB_HFP_SUPPORTED_FEATURES attribute
//
#define HFP_AG_SDP_SUPPORTED_FEATURE_THREE_WAY_CALLING              (0x0001)    // Bit 0
#define HFP_AG_SDP_SUPPORTED_FEATURE_ECHO_CANCELLATION              (0x0002)    // Bit 1
#define HFP_AG_SDP_SUPPORTED_FEATURE_VOICE_RECOGNITION              (0x0004)    // Bit 2
#define HFP_AG_SDP_SUPPORTED_FEATURE_INBAND_RING_TONE               (0x0008)    // Bit 3
#define HFP_AG_SDP_SUPPORTED_FEATURE_VOICE_TAG                      (0x0010)    // Bit 4
#define HFP_AG_SDP_SUPPORTED_FEATURE_WIDE_BAND_SPEECH               (0x0020)    // Bit 5
#define HFP_AG_SDP_SUPPORTED_FEATURE_ENHANCED_VOICE_RECOGNITION     (0x0040)    // Bit 6
#define HFP_AG_SDP_SUPPORTED_FEATURE_VOICE_RECOGNITION_TEXT         (0x0080)    // Bit 7
#define HFP_AG_SDP_SUPPORTED_FEATURE_SUPER_WIDE_BAND_SPEECH         (0x0100)    // Bit 8

//
// HFP Audio Gateway BRSF (AT+BRSF) Supported Features
// Used in the +BRSF response from the Audio Gateway
//
#define HFP_AG_BRSF_SUPPORTED_FEATURE_THREE_WAY_CALLING         (0x0001)    // Bit 0
#define HFP_AG_BRSF_SUPPORTED_FEATURE_ECHO_CANCELLATION         (0x0002)    // Bit 1
#define HFP_AG_BRSF_SUPPORTED_FEATURE_VOICE_RECOGNITION         (0x0004)    // Bit 2
#define HFP_AG_BRSF_SUPPORTED_FEATURE_INBAND_RING_TONE          (0x0008)    // Bit 3
#define HFP_AG_BRSF_SUPPORTED_FEATURE_VOICE_TAG                 (0x0010)    // Bit 4
#define HFP_AG_BRSF_SUPPORTED_FEATURE_REJECT_CALL               (0x0020)    // Bit 5
#define HFP_AG_BRSF_SUPPORTED_FEATURE_ENHANCED_CALL_STATUS      (0x0040)    // Bit 6
#define HFP_AG_BRSF_SUPPORTED_FEATURE_ENHANCED_CALL_CONTROL     (0x0080)    // Bit 7
#define HFP_AG_BRSF_SUPPORTED_FEATURE_EXTENDED_ERROR_CODES      (0x0100)    // Bit 8
#define HFP_AG_BRSF_SUPPORTED_FEATURE_CODEC_NEGOTIATION         (0x0200)    // Bit 9
#define HFP_AG_BRSF_SUPPORTED_FEATURE_HF_INDICATORS             (0x0400)    // Bit 10
#define HFP_AG_BRSF_SUPPORTED_FEATURE_ESCO_S4_SETTINGS          (0x0800)    // Bit 11

//
// HFP Network Support values for SDP record
//
#define HFP_NETWORK_NO_ABILITY_TO_REJECT    (0x00)
#define HFP_NETWORK_ABILITY_TO_REJECT       (0x01)

//
// HFP (Hands-Free Profile) Hands-Free Unit SDP Supported Features
// Used in SDP_ATTRIB_HFP_SUPPORTED_FEATURES attribute
//
#define HFP_HF_SDP_SUPPORTED_FEATURE_ECHO_CANCELLATION              (0x0001)    // Bit 0
#define HFP_HF_SDP_SUPPORTED_FEATURE_THREE_WAY_CALLING              (0x0002)    // Bit 1
#define HFP_HF_SDP_SUPPORTED_FEATURE_CLI_PRESENTATION               (0x0004)    // Bit 2
#define HFP_HF_SDP_SUPPORTED_FEATURE_VOICE_RECOGNITION              (0x0008)    // Bit 3
#define HFP_HF_SDP_SUPPORTED_FEATURE_REMOTE_VOLUME_CONTROL          (0x0010)    // Bit 4
#define HFP_HF_SDP_SUPPORTED_FEATURE_WIDE_BAND_SPEECH               (0x0020)    // Bit 5
#define HFP_HF_SDP_SUPPORTED_FEATURE_ENHANCED_VOICE_RECOGNITION     (0x0040)    // Bit 6
#define HFP_HF_SDP_SUPPORTED_FEATURE_SUPER_WIDE_BAND_SPEECH         (0x0080)    // Bit 7

//
// HFP Hands-Free Unit BRSF (AT+BRSF) Supported Features
// Used in the AT+BRSF command from the Hands-Free unit
//
#define HFP_HF_BRSF_SUPPORTED_FEATURE_ECHO_CANCELLATION             (0x0001)    // Bit 0
#define HFP_HF_BRSF_SUPPORTED_FEATURE_THREE_WAY_CALLING             (0x0002)    // Bit 1
#define HFP_HF_BRSF_SUPPORTED_FEATURE_CLI_PRESENTATION              (0x0004)    // Bit 2
#define HFP_HF_BRSF_SUPPORTED_FEATURE_VOICE_RECOGNITION             (0x0008)    // Bit 3
#define HFP_HF_BRSF_SUPPORTED_FEATURE_REMOTE_VOLUME_CONTROL         (0x0010)    // Bit 4
#define HFP_HF_BRSF_SUPPORTED_FEATURE_ENHANCED_CALL_STATUS          (0x0020)    // Bit 5
#define HFP_HF_BRSF_SUPPORTED_FEATURE_ENHANCED_CALL_CONTROL         (0x0040)    // Bit 6
#define HFP_HF_BRSF_SUPPORTED_FEATURE_CODEC_NEGOTIATION             (0x0080)    // Bit 7
#define HFP_HF_BRSF_SUPPORTED_FEATURE_HF_INDICATORS                 (0x0100)    // Bit 8
#define HFP_HF_BRSF_SUPPORTED_FEATURE_ESCO_S4_SETTINGS              (0x0200)    // Bit 9
#define HFP_HF_BRSF_SUPPORTED_FEATURE_ENHANCED_VOICE_RECOGNITION    (0x0400)    // Bit 10
#define HFP_HF_BRSF_SUPPORTED_FEATURE_VOICE_RECOGNITION_TEXT        (0x0800)    // Bit 11
