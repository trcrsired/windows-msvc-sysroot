...
//
// MessageId: SOFT_RESTART_LIVE_DUMP
//
// MessageText:
//
//  SOFT_RESTART_LIVE_DUMP
//
#define SOFT_RESTART_LIVE_DUMP           ((ULONG)0x00000071L)
...
//
// MessageId: DRIVER_VERIFIER_MISMATCH
//
// MessageText:
//
//  DRIVER_VERIFIER_MISMATCH
//
#define DRIVER_VERIFIER_MISMATCH         ((ULONG)0x000000DDL)
...
//
// MessageId: INVALID_CACHED_SYSTEM_TABLE
//
// MessageText:
//
//  INVALID_CACHED_SYSTEM_TABLE
//
#define INVALID_CACHED_SYSTEM_TABLE      ((ULONG)0x00000204L)

//
// MessageId: KCSAN_RACY_ACCESS
//
// MessageText:
//
//  KCSAN_RACY_ACCESS
//
#define KCSAN_RACY_ACCESS                ((ULONG)0x00000205L)

//
// MessageId: MULTITIER_MEMORY_DRIVER_INTERNAL
//
// MessageText:
//
//  MULTITIER_MEMORY_DRIVER_INTERNAL
//
#define MULTITIER_MEMORY_DRIVER_INTERNAL ((ULONG)0x00000206L)

//
// MessageId: FILEINFO_POSSIBLE_DEADLOCK_LIVE_DUMP
//
// MessageText:
//
//  FILEINFO_POSSIBLE_DEADLOCK_LIVE_DUMP
//
#define FILEINFO_POSSIBLE_DEADLOCK_LIVE_DUMP ((ULONG)0x00000207L)
...
//
#define STORAGE_DRIVER_LIVEDUMP          ((ULONG)0x00000208L)

//
// MessageId: STORVSP_LIVEDUMP
//
// MessageText:
//
//  STORVSP_LIVEDUMP
//
#define STORVSP_LIVEDUMP                 ((ULONG)0x40000209L)

//
// MessageId: INTERRUPTS_STATE_MISMATCH
//
// MessageText:
//
//  INTERRUPTS_STATE_MISMATCH
//
#define INTERRUPTS_STATE_MISMATCH        ((ULONG)0x0000020AL)

//
// MessageId: TEST_INITIATED_CRASH
//
// MessageText:
//
//  TEST_INITIATED_CRASH
//
#define TEST_INITIATED_CRASH             ((ULONG)0x0000020BL)
...
//
// MessageId: ASSERTBUGCODE_I3CHOST_DRIVER
//
// MessageText:
//
//  ASSERTBUGCODE_I3CHOST_DRIVER
//
#define ASSERTBUGCODE_I3CHOST_DRIVER     ((ULONG)0x00000423L)
...
//
// MessageId: MANUALLY_INITIATED_POWER_BUTTON_HOLD_KERNEL_LIVE_DUMP
//
// MessageText:
//
//  MANUALLY_INITIATED_POWER_BUTTON_HOLD_KERNEL_LIVE_DUMP
//
#define MANUALLY_INITIATED_POWER_BUTTON_HOLD_KERNEL_LIVE_DUMP ((ULONG)0x000031C8L)
...
#define SMBD_BUGCHECK_CODE ((ULONG)0x534D4244)
#endif // _BUGCODES_
