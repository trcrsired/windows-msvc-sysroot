...
// {693A0A1C-7B4F-405C-B040-535372287449}
EXTERN_C __declspec(selectany) const GUID SEC_WINNT_AUTH_DATA_TYPE_PLACEHOLDER =
{ 0x693a0a1c, 0x7b4f, 0x405c, { 0xb0, 0x40, 0x53, 0x53, 0x72, 0x28, 0x74, 0x49 } };
