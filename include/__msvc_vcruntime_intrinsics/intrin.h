...
__MACHINEARM64(double _CopyDoubleFromInt64(__int64))
__MACHINEARM64(float _CopyFloatFromInt32(__int32))
__MACHINEARM64(__int32 _CopyInt32FromFloat(float))
__MACHINEARM64(__int64 _CopyInt64FromDouble(double))
__MACHINEARM64(unsigned int _CountLeadingOnes(unsigned long))
__MACHINEARM64(unsigned int _CountLeadingOnes64(unsigned __int64))
__MACHINEARM64(unsigned int _CountLeadingSigns(long))
__MACHINEARM64(unsigned int _CountLeadingSigns64(__int64))
__MACHINEARM64(unsigned int _CountOneBits(unsigned long))
__MACHINEARM64(unsigned int _CountOneBits64(unsigned __int64))
...
__MACHINEARM64(long _InterlockedAdd(long volatile * _Addend, long _Value))
__MACHINE(long _interlockedadd(long volatile * _Addend, long _Value))
__MACHINEARM64(__int64 _InterlockedAdd64(__int64 volatile * _Addend, __int64 _Value))
__MACHINE(__int64 _interlockedadd64(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM64(__int64 _InterlockedAdd64_acq(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM64(__int64 _InterlockedAdd64_nf(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM64(__int64 _InterlockedAdd64_rel(__int64 volatile * _Addend, __int64 _Value))
__MACHINEX86(long _InterlockedAddLargeStatistic(__int64 volatile * _Addend, long _Value))
__MACHINEARM64(long _InterlockedAdd_acq(long volatile * _Addend, long _Value))
__MACHINEARM64(long _InterlockedAdd_nf(long volatile * _Addend, long _Value))
__MACHINEARM64(long _InterlockedAdd_rel(long volatile * _Addend, long _Value))
...
__MACHINEARM64(unsigned char _interlockedbittestandset_acq(long volatile *, long))
__MACHINEARM64(unsigned char _interlockedbittestandset_nf(long volatile *, long))
__MACHINEARM64(unsigned char _interlockedbittestandset_rel(long volatile *, long))
...
__MACHINEARM64(void * _InterlockedCompareExchangePointer_acq(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM64(void * _InterlockedCompareExchangePointer_nf(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEX64(void * _InterlockedCompareExchangePointer_np(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM64(void * _InterlockedCompareExchangePointer_rel(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEX64(long _InterlockedCompareExchange_np(long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEARM64(short _InterlockedDecrement16_acq(short volatile * _Addend))
__MACHINEARM64(short _InterlockedDecrement16_nf(short volatile * _Addend))
__MACHINEARM64(short _InterlockedDecrement16_rel(short volatile * _Addend))
__MACHINEARM64(__int64 _InterlockedDecrement64_acq(__int64 volatile * _Addend))
__MACHINEARM64(__int64 _InterlockedDecrement64_nf(__int64 volatile * _Addend))
__MACHINEARM64(__int64 _InterlockedDecrement64_rel(__int64 volatile * _Addend))
__MACHINEARM64(long _InterlockedDecrement_acq(long volatile * _Addend))
__MACHINEARM64(long _InterlockedDecrement_nf(long volatile * _Addend))
__MACHINEARM64(long _InterlockedDecrement_rel(long volatile * _Addend))
__MACHINE(void * _InterlockedExchangePointer(void * volatile * _Target, void * _Value))
__MACHINEARM64(void * _InterlockedExchangePointer_acq(void * volatile * _Target, void * _Value))
__MACHINEARM64(void * _InterlockedExchangePointer_nf(void * volatile * _Target, void * _Value))
__MACHINEARM64(void * _InterlockedExchangePointer_rel(void * volatile * _Target, void * _Value))
__MACHINEARM64(short _InterlockedIncrement16_acq(short volatile * _Addend))
__MACHINEARM64(short _InterlockedIncrement16_nf(short volatile * _Addend))
__MACHINEARM64(short _InterlockedIncrement16_rel(short volatile * _Addend))
__MACHINEARM64(__int64 _InterlockedIncrement64_acq(__int64 volatile * _Addend))
__MACHINEARM64(__int64 _InterlockedIncrement64_nf(__int64 volatile * _Addend))
__MACHINEARM64(__int64 _InterlockedIncrement64_rel(__int64 volatile * _Addend))
__MACHINEARM64(long _InterlockedIncrement_acq(long volatile * _Addend))
__MACHINEARM64(long _InterlockedIncrement_rel(long volatile * _Addend))
...
__MACHINEARM64(void __emit(unsigned __int32))
...
__MACHINEARM64(unsigned int __hvc(unsigned int, ...))
...
__MACHINEARM64(void __cdecl __prefetch(const void *))
...
__MACHINEARM64(void __sev(void))
__MACHINEX86_X64(void __sidt(void *))
__MACHINEARM64(void __static_assert(int, const char *))
...
__MACHINEARM64(void __wfe(void))
__MACHINEARM64(void __wfi(void))
...
__MACHINEARM64(unsigned char _interlockedbittestandreset_acq(long volatile *, long))
__MACHINEARM64(unsigned char _interlockedbittestandreset_nf(long volatile *, long))
__MACHINEARM64(unsigned char _interlockedbittestandreset_rel(long volatile *, long))
...
__MACHINEARM64_X64(int __cdecl _setjmpex(jmp_buf))
